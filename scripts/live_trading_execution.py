...
from adapters.ctrader.risk_guard import FTMOConfig, FTMO_PROFILE_CHALLENGE
...
class LiveTradingExecutor:
    ...
    def _setup_trading(self):
        ftmo_profile = FTMO_PROFILE_CHALLENGE
        ftmo_config = FTMOConfig(
            daily_loss_limit_pct=ftmo_profile.daily_loss_limit_pct,
            total_drawdown_limit_pct=self._config.ftmo_max_drawdown,
            max_position_size_pct=ftmo_profile.risk_per_trade_pct,
        )
        position_config = PositionSizeConfig(
            risk_per_trade_pct=ftmo_profile.risk_per_trade_pct,
        )
