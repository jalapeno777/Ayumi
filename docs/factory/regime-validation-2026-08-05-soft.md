...
**Generated:** 2026-08-05T09:31:13.870575+00:00
**DuckDB:** `/home/TacoPants/projects/Ayumi/data/ayumi_market.duckdb`
**MTF mode:** `soft`
**Detector config:** adx_period=14, atr_period=14, atr_lookback=50, trending_adx=25.0, choppy_adx=20.0, volatile_atr_pct=0.8, quiet_atr_pct=0.2, mtf_confirmation=soft, h1_adx_threshold=22.0, h4_adx_threshold=20.0
...
|---|-------|--------|--------|---------------:|----------------------:|-----------------------:|---------:|:----:|
| 1 | 2020 COVID Crash | EURUSD | 2020-03-01 → 2020-04-15 | 2468 | 73.2% | 67.6% | 70.4% | ✅ |
| 2 | 2022 Fed Rate Shock | XAUUSD | 2022-06-01 → 2022-09-30 | 7854 | 59.0% | 67.6% | 63.3% | ❌ |
...
**Combined conceptual accuracy:** 70.4% (average of VOLATILE + TRENDING conceptual accuracy)
...
**Combined conceptual accuracy:** 63.3% (average of VOLATILE + TRENDING conceptual accuracy)

**Expectations check:**

- ✅ `volatile` ≥ 10% (actual: 26.6% — Elevated intraday volatility around FOMC)
- ❌ `trending` ≥ 20% (actual: 19.1% — Sustained downtrend in gold through summer)
...
|--------|-----------|-----------:|---------:|-------:|---------:|------:|:----:|
| XAUUSD | M15 | 104380 | 21.3% | 17.5% | 24.7% | 36.5% | ✅ |
| EURUSD | M15 | 100798 | 14.1% | 11.8% | 33.8% | 40.4% | ❌ |
