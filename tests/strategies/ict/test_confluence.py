...
def trending_bars():
    return [
        ...
        Bar(time=datetime(2024, 1, 1, 1, 0), open=1.1005, high=1.1020, low=1.1000, close=1.1015),
        Bar(time=datetime(2024, 1, 1, 2, 0), open=1.1015, high=1.1030, low=1.1010, close=1.1020),
        Bar(time=datetime(2024, 1, 1, 3, 0), open=1.1020, high=1.1040, low=1.1015, close=1.1035),
        Bar(time=datetime(2024, 1, 1, 4, 0), open=1.1035, high=1.1050, low=1.1030, close=1.1040),
        Bar(time=datetime(2024, 1, 1, 5, 0), open=1.1040, high=1.1048, low=1.1035, close=1.1038),
        Bar(time=datetime(2024, 1, 1, 6, 0), open=1.1038, high=1.1042, low=1.1030, close=1.1032),
        Bar(time=datetime(2024, 1, 1, 7, 0), open=1.1032, high=1.1038, low=1.1025, close=1.1028),
        Bar(time=datetime(2024, 1, 1, 8, 0), open=1.1028, high=1.1035, low=1.1020, close=1.1025),
        Bar(time=datetime(2024, 1, 1, 9, 0), open=1.1025, high=1.1030, low=1.1015, close=1.1020),
        Bar(time=datetime(2024, 1, 1, 10, 0), open=1.1020, high=1.1030, low=1.1010, close=1.1025),
    ]
...
class TestConfluenceEngine:
    def test_evaluate_returns_signal_or_none(self, market_state):
        ...
        if signal is not None:
            ...
            assert signal.direction in [TradeDirection.LONG, TradeDirection.SHORT, TradeDirection.NEUTRAL]
